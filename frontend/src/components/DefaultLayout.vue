          ...
          <div class="hidden md:block">
            ...
            <Menu as="div" class="relative ml-3">
              ...
              <transition enter-active-class="transition ease-out duration-100"
                ...
                <MenuItems
                  class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-hidden hover:bg-gray-200 cursor-pointer">
                  <MenuItem>
                  <button @click="logout" class="block px-4 py-2 text-sm text-gray-700">Sign
                    out</button>
                  </MenuItem>
                </MenuItems>
              </transition>
